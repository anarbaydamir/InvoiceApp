...
<head>
    ...
    <script src="assets/js/reportbyproject.js"></script>
    <%--    search dropdown--%>
...
<div class="container">
    <br>
    <h4>Report</h4>
    <form action="projectreport" method="get" onsubmit="return checkProject()">
    <div class="row">
        <div class="col-sm-6">
            <select id="projectName_id" name="projectId" class="form-control select2">
